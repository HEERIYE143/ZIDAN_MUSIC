...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("PICKUPMUSIC/assets/font2.ttf", 30)
    font = ImageFont.truetype("PICKUPMUSIC/assets/font.ttf", 30)
    title_font = ImageFont.truetype("PICKUPMUSIC/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("PICKUPMUSIC/assets/play_icons.png")
