...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/HEERIYE143/ZIDAN_MUSIC",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/AboutshayarAkhawab")
